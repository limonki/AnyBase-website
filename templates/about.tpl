    ...
    <div class="header">
      ...
      <header class="scroll">
        <nav class="vertical-align-middle">
          ...
          <span class="nav-item"><a class="active"href="about.php">{MENU.7}</a></span>
        </nav>
      </header>
    </div>
  </div>
  ...
  <div class="main">
    <div class="row">
      <div class="col-18 main-title">
        <h1>{ABOUT.TITLE}</h1>
        <div class="text anim">{ABOUT.TEXT}</div>
        <div class="start anim col-18">
          <div class="text anim change-title">{ABOUT.TITLE.1}</div>
          <div class="col-6 anim center"><img class="creator" src="images/creator.png"></div>
          <div class="col-12 anim"><div class="text">{ABOUT.TEXT.1}</div></div>
        </div>
      </div>
    </div>
  </div>
